...
response_template_in_state = {
    ...
    6: ['Готово. Вы можете создать новый или отправить всем этот. пожалуйста, подтвердите написав номер поста для публикации: ',
        'Готово. Вы можете создать новый или отправить всем этот. пожалуйста, подтвердите написав номер поста для публикации: ']
}
